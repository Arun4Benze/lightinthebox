...
import { LoginContextValue } from '../../Contexts/LoginContext.jsx';

const Home = () => {
  const {user}=useContext(LoginContextValue);
  ...
  const rupees=useContext(CartContextValue)
  return (
    <>
