...
const AllCategory = ({HandleCategoryClick,HandleMouseLeaveAllCategories,allCategoryWidthObj}) => {
  ...
  return (
    <>
      <div style={allCategoryWidthObj} className='category' onMouseLeave={HandleMouseLeaveAllCategories}>
